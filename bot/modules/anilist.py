...
bot.add_handler(MessageHandler(anilist, filters=command(BotCommands.AniListCommand) & private))
bot.add_handler(MessageHandler(character, filters=command("character") & private))
bot.add_handler(MessageHandler(manga, filters=command("manga") & private))
bot.add_handler(MessageHandler(anime_help, filters=command(BotCommands.AnimeHelpCommand) & private))
